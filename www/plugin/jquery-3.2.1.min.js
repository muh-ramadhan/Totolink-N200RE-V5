!(function (e, t) {
  ...
  var t = (function (P) {
      ...
      try {
        N.apply((t = Y.call(y.childNodes)), y.childNodes),
          ...
          if (d.qsa && !v[e + " "] && (!g || !g.test(e))) {
            if (1 !== p) (f = t), (c = e);
              ...
              for (
                ...
                l[o] = "#" + a + " " + F(l[o]);
              (c = l.join(",")), (f = (ue.test(e) && ge(t.parentNode)) || t);
            }
            if (c)
              try {
                return N.apply(n, f.querySelectorAll(c)), n;
              } catch (e) {
              } finally {
            ...
            ? e.parentNode && !1 === e.disabled
              ? "label" in e
                ? "label" in e.parentNode
                  ...
                  : e.disabled === t
                : e.isDisabled === t || (e.isDisabled !== !t && ce(e) === t)
              : e.disabled === t
        ...
        function (e) {
          ...
          return (
            e !== C &&
              ...
              (d.getElementsByClassName = c.test(C.getElementsByClassName)),
              (d.getById = L(function (e) {
                return (
                  (n.appendChild(e).id = k),
              ...
              (r = []),
              (g = []),
              (d.qsa = c.test(C.querySelectorAll)) &&
                (L(function (e) {
                    ...
                    return e === t
                      ...
                      : (n =
                          ...
                          (!d.sortDetached &&
                            ...
                            ? e === C || (e.ownerDocument === y && m(y, e))
                              ? -1
                              : t === C || (t.ownerDocument === y && m(y, t))
                              ? 1
                              : u
                              ? x(u, e) - x(u, t)
                              : 0
      ...
      (A.attr = function (e, t) {
        ...
        var n = b.attrHandle[t.toLowerCase()],
          n = n && U.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !E) : void 0;
        return void 0 !== n
          ? n
          : d.attributes || !E
          ? e.getAttribute(t)
      ...
      ((b = A.selectors =
        {
          ...
          pseudos: {
            ...
            lang: q(function (n) {
              return (
                ie.test(n || "") || A.error("unsupported lang: " + n),
      ...
      function xe(d, h, g, m, y, e) {
        return (
          ...
          q(function (e, t, n, r) {
            ...
            } else (p = ve(p === t ? p.splice(l, p.length) : p)), y ? y(null, t, p, r) : N.apply(t, p);
          })
        );
      }
      function be(m, y) {
        function e(e, t, n, r, i) {
          ...
          if (((u += l), v && l !== u)) {
            ...
            if (e) {
              if (0 < u) for (; l--; ) c[l] || f[l] || (f[l] = V.call(r));
              f = ve(f);
            }
            N.apply(r, f),
              i && !e && 0 < f.length && 1 < u + y.length && A.uniqueSort(r);
          }
          return i && ((S = h), (w = p)), c;
        }
        var v = 0 < y.length,
      ...
      return (
        ...
        (h = A.tokenize =
          function (e, t) {
            ...
            return t ? s.length : s ? A.error(e) : z(e, a).slice(0);
          }),
        (W = A.compile =
          function (e, t) {
            var n,
              ...
              for (n = (t = t || h(e)).length; n--; )
                ((o = (function e(t) {
                  for (
                    ...
                    if ((n = b.relative[t[u].type])) f = [O(ye(f), n)];
                    else {
                      if (
          ...
          function (e, t, n, r) {
            ...
            if (((n = n || []), 1 === c.length)) {
              if (
                ...
                if (!(t = (b.find.ID(s.matches[0].replace(j, f), t) || [])[0]))
                  return n;
                l && (t = t.parentNode), (e = e.slice(o.shift().value.length));
              }
              for (
                i = p.needsContext.test(e) ? 0 : o.length;
  ...
  function ae(e, t, n, r) {
    var i;
    try {
      e && C.isFunction((i = e.promise))
        ? i.call(e).done(t).fail(n)
        : e && C.isFunction((i = e.then))
        ? i.call(e, t, n)
  ...
  (C.Callbacks = function (r) {
    ...
    C.extend({
          ...
          s = {
            ...
            then: function (t, n, r) {
              ...
              return C.Deferred(function (e) {
                o[0][3].add(l(0, e, C.isFunction(r) ? r : c, e.notifyWith)),
                  o[1][3].add(l(0, e, C.isFunction(t) ? t : c)),
                  o[2][3].add(l(0, e, C.isFunction(n) ? n : se));
              }).promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          n <= 1 &&
          (ae(e, s.done(t(r)).resolve, s.reject, !n),
          "pending" === s.state() || C.isFunction(o[r] && o[r].then))
        )
          return s.then();
        for (; r--; ) ae(o[r], t(r), s.reject);
        return s.promise();
      },
    });
  var ue = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/,
    le =
      ...
      C.Deferred());
  function ce() {
    T.removeEventListener("DOMContentLoaded", ce),
      w.removeEventListener("load", ce),
      C.ready();
  }
  (C.fn.ready = function (e) {
    ...
    ("loading" !== T.readyState && !T.documentElement.doScroll)
      ...
      : (T.addEventListener("DOMContentLoaded", ce),
        w.addEventListener("load", ce));
        ...
        if (
          ...
          for (t = s.length; t--; )
            s[t] &&
              ...
              ((r = C.camelCase(r.slice(5))), he(o, r, i[r]));
  ...
  function ye(e, t, n, r) {
    var i,
      ...
      c = (C.cssNumber[t] || ("px" !== l && +u)) && p.exec(C.css(e, t));
    if (c && c[3] !== l)
      for (
        l = l || c[3], n = n || [], c = +u || 1;
        C.style(e, t, (c /= o = o || ".5") + l),
          o !== (o = a() / u) && 1 !== o && --s;
            ...
            "" === r.style.display &&
              ...
              (a[u] =
                ...
                (s = ve[i]) ||
                  ...
                  (ve[i] = s = "none" === s ? "block" : s)))))
          : "none" !== n && ((a[u] = "none"), y.set(r, "display", n)));
  ...
  function Ee(e, t, n, r, i) {
    ...
    for (c.textContent = "", p = 0; (o = f[p++]); )
      if (r && -1 < C.inArray(o, r)) i && i.push(o);
        ...
        for (l = 0; (o = s[l++]); ) we.test(o.type || "") && n.push(o);
    return c;
  }
  (t = T.createDocumentFragment().appendChild(T.createElement("div"))),
    (j = T.createElement("input")).setAttribute("type", "radio"),
      ...
      if (h)
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            i && C.find.matchesSelector(ke, i),
            n.guid || (n.guid = C.guid++),
            a = (a = h.events) || (h.events = {}),
            s =
              (s = h.handle) ||
              (h.handle = function (e) {
  ...
  function We(e, t) {
    ...
    if (1 === t.nodeType) {
      ...
      l.hasData(e) && ((o = l.access(e)), (s = C.extend({}, o)), l.set(t, s));
    }
  }
  function b(n, r, i, o) {
    r = M.apply([], r);
    var e,
      ...
      d = r[0],
      h = C.isFunction(d);
    if (h || (1 < f && "string" == typeof d && !g.checkClone && Fe.test(d)))
      return n.each(function (e) {
        var t = n.eq(e);
        h && (r[0] = d.call(this, e, t.html())), b(t, r, i, o);
      });
    if (
      f &&
      ((t = (e = Ee(r, n[0].ownerDocument, !1, n, o)).firstChild),
      1 === e.childNodes.length && (e = t),
      t || o)
    ) {
      for (a = (s = C.map(v(e, "script"), Me)).length; c < f; c++)
        (u = e),
          c !== p &&
            ((u = C.clone(u, !0, !0)), a) &&
            C.merge(s, v(u, "script")),
          i.call(n[c], u, c);
      if (a)
        for (l = s[s.length - 1].ownerDocument, C.map(s, Ie), c = 0; c < a; c++)
          (u = s[c]),
            we.test(u.type || "") &&
              ...
              (u.src
                ...
                : z(u.textContent.replace(Pe, ""), l));
    }
    return n;
  }
  function $e(e, t, n) {
    for (var r, i = t ? C.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || C.cleanData(v(r)),
        r.parentNode &&
          (n && C.contains(r.ownerDocument, r) && Te(v(r, "script")),
  ...
  C.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (s = v(c), r = 0, i = (o = v(e)).length; r < i; r++)
          (a = o[r]),
            (u = s[r]),
            (l = void 0),
      ...
      if (t)
        if (n)
          for (o = o || v(e), s = s || v(c), r = 0, i = o.length; r < i; r++)
            We(o[r], s[r]);
        else We(e, c);
      return 0 < (s = v(c, "script")).length && Te(s, !f && v(e, "script")), c;
    },
    ...
    C.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (C.cleanData(v(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return f(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !He.test(e) &&
              !h[(be.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = C.htmlPrefilter(e);
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (C.cleanData(v(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
  ...
  (s = T.createElement("div")),
    (k = T.createElement("div")).style &&
      ((k.style.backgroundClip = "content-box"),
      (k.cloneNode(!0).style.backgroundClip = ""),
      (g.clearCloneStyle = "content-box" === k.style.backgroundClip),
      (s.style.cssText =
  ...
  function ot(e, t, n, r, i) {
    for (
      var o = 0,
        s = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0;
      s < 4;
      s += 2
    )
      "margin" === n && (o += C.css(e, n + d[s], !0, i)),
        r
          ? ("content" === n && (o -= C.css(e, "padding" + d[s], !0, i)),
            "margin" !== n && (o -= C.css(e, "border" + d[s] + "Width", !0, i)))
          : ((o += C.css(e, "padding" + d[s], !0, i)),
            "padding" !== n &&
              (o += C.css(e, "border" + d[s] + "Width", !0, i)));
    return o;
  }
  function st(e, t, n) {
    var r,
    ...
    return Ge.test(o)
      ? o
      : ((r = s && (g.boxSizingReliable() || o === e.style[t])),
        "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]),
        (o = parseFloat(o) || 0) +
          ot(e, t, n || (s ? "border" : "content"), r, i) +
          "px");
  }
  ...
  C.extend({
      ...
      C.cssHooks[i] = {
        ...
        set: function (e, t, n) {
          var r = n && Be(e),
            n =
              n &&
              ot(e, i, n, "border-box" === C.css(e, "boxSizing", !1, r), r);
          return (
            n &&
              (r = p.exec(t)) &&
              "px" !== (r[3] || "px") &&
              ((e.style[i] = t), (t = C.css(e, i))),
            it(0, t, n)
          );
        },
      };
    ...
    C.each({ margin: "", padding: "", border: "Width" }, function (i, o) {
      (C.cssHooks[i + o] = {
        ...
        Ve.test(i) || (C.cssHooks[i + o].set = it);
    }),
    C.fn.extend({
      css: function (e, t) {
        return f(
    ...
    (((C.Tween = N).prototype = {
      ...
      run: function (e) {
        ...
        return (
          ...
          (n && n.set ? n : N.propHooks._default).set(this),
          this
        );
      },
  ...
  function ct() {
    at &&
      (!1 === T.hidden && w.requestAnimationFrame
        ? w.requestAnimationFrame(ct)
        : w.setTimeout(ct, C.fx.interval),
      C.fx.tick());
  }
  function ft() {
    return (
  ...
  (C.Animation = C.extend(A, {
    tweeners: {
      "*": [
        function (e, t) {
          ...
          return ye(n.elem, e, p.exec(t), n), n;
        },
      ],
    },
        ...
        if ((u = !C.isEmptyObject(t)) || !C.isEmptyObject(p))
          ...
          p))
            u ||
              ...
              h && m([e], !0),
              f.done(function () {
                for (r in (h || m([e]), y.remove(e, "fxshow"), p))
                  C.style(e, r, p[r]);
              })),
              (u = dt(h ? g[r] : 0, r, f)),
              r in g ||
      ...
      stop: function (i, e, o) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (t in r) r[t] && r[t].stop && lt.test(t) && s(r[t]);
            for (t = n.length; t--; )
              n[t].elem !== this ||
                (null != i && n[t].queue !== i) ||
    ...
    (C.fx.tick = function () {
      var e,
        t = 0,
        n = C.timers;
      for (D = C.now(); t < n.length; t++)
        (e = n[t])() || n[t] !== e || n.splice(t--, 1);
      n.length || C.fx.stop(), (D = void 0);
    }),
    ...
    C.fn.extend({
      addClass: function (t) {
        ...
        if ("string" == typeof t && t)
          for (e = t.match(E) || []; (n = this[a++]); )
            if (((s = H(n)), (r = 1 === n.nodeType && " " + L(s) + " "))) {
              for (o = 0; (i = e[o++]); )
                r.indexOf(" " + i + " ") < 0 && (r += i + " ");
        ...
        return "boolean" == typeof t && "string" == o
          ...
          : this.each(function () {
              ...
              if ("string" == o)
                ...
                (void 0 !== i && "boolean" != o) ||
                  ((e = H(this)) && y.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      hasClass: function (e) {
        for (var t, n = 0, r = " " + e + " "; (t = this[n++]); )
          if (1 === t.nodeType && -1 < (" " + L(H(t)) + " ").indexOf(r))
            return !0;
        return !1;
      },
    });
      ...
      (C.extend(C.event, {
        trigger: function (e, t, n, r) {
          ...
          if (
            3 !== n.nodeType &&
            8 !== n.nodeType &&
            !vt.test(f + C.event.triggered) &&
            (-1 < f.indexOf(".") &&
              ((f = (p = f.split(".")).shift()), p.sort()),
            (a = f.indexOf(":") < 0 && "on" + f),
            ((e = e[C.expando]
              ? e
              : new C.Event(f, "object" == typeof e && e)).isTrigger = r
              ? 2
              : 3),
            (e.namespace = p.join(".")),
            ...
            if (!r && !l.noBubble && !C.isWindow(n)) {
              for (
                s = l.delegateType || f, vt.test(s + f) || (d = d.parentNode);
                d;
                d = d.parentNode
              )
                c.push(d), (o = d);
            ...
            for (i = 0; (d = c[i++]) && !e.isPropagationStopped(); )
              (e.type = 1 < i ? s : l.bindType || f),
                (u =
                  (y.get(d, "events") || {})[e.type] && y.get(d, "handle")) &&
                  u.apply(d, t),
                (u = a && d[a]) &&
                  u.apply &&
                  fe(d) &&
                  ((e.result = u.apply(d, t)), !1 === e.result) &&
                  e.preventDefault();
            return (
              (e.type = f),
              r ||
      ...
      ajax: function (e, t) {
        ...
        var u,
          ...
          b = {
            ...
            getResponseHeader: function (e) {
              ...
              if (p) {
                if (!n)
                  for (n = {}; (t = Dt.exec(c)); ) n[t[1].toLowerCase()] = t[2];
                t = n[e.toLowerCase()];
              }
        ...
        if (
          ...
          h.hasContent
            ...
            : ((e = h.url.slice(l.length)),
              h.data &&
                ((l += (bt.test(l) ? "&" : "?") + h.data), delete h.data),
              !1 === h.cache &&
                ((l = l.replace(Nt, "$1")),
                (e = (bt.test(l) ? "&" : "?") + "_=" + xt++ + e)),
              (h.url = l + e)),
          ...
          if (
            ...
            if (((b.readyState = 1), d && m.trigger("ajaxSend", [b, h]), p))
              return b;
            h.async &&
              0 < h.timeout &&
        ...
        function a(e, t, n, r) {
          ...
          p ||
            ...
            (b.status = e),
            (b.statusText = (t || a) + ""),
            r ? y.resolveWith(g, [i, a, b]) : y.rejectWith(g, [b, a, o]),
            b.statusCode(x),
            (x = void 0),
  ...
  var Mt = { 0: 200, 1223: 204 },
    ...
    It =
      ((g.cors = !!O && "withCredentials" in O),
      (g.ajax = O = !!O),
      C.ajaxTransport(function (i) {
        var o, s;
        if (g.cors || (O && !i.crossDomain))
          return {
            send: function (e, t) {
              var n,
                r = i.xhr();
    ...
    $t =
          ...
          return (
            ...
            n.always(function () {
              void 0 === i ? C(w).removeProp(r) : (w[r] = i),
                e[r] && ((e.jsonpCallback = t.jsonpCallback), It.push(r)),
          ...
          return arguments.length
            ...
            ? r.getClientRects().length
              ? ((n = r.getBoundingClientRect()),
                (e = (r = r.ownerDocument).documentElement),
                (r = r.defaultView),
                {
                  top: n.top + r.pageYOffset - e.clientTop,
                  left: n.left + r.pageXOffset - e.clientLeft,
                })
              : { top: 0, left: 0 }
            : void 0;
        },
      ...
      C.each(["top", "left"], function (e, n) {
        C.cssHooks[n] = Qe(g.pixelPosition, function (e, t) {
          if (t)
            return (t = S(e, n)), Ge.test(t) ? C(e).position()[n] + "px" : t;
        });
      }),
  ...
  return (
    (C.noConflict = function (e) {
      return w.$ === C && (w.$ = Bt), e && w.jQuery === C && (w.jQuery = $t), C;
    }),
    P || (w.jQuery = w.$ = C),
    C
  );
